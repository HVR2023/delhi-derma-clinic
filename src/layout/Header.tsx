                ...
                <div className={`offcanvas dz-offcanvas offcanvas offcanvas-end ${show == 1 ? 'show' : ''}`} tabIndex={-1} id="headerSidebar">
                    ...
                    <div className="offcanvas-body">
                        <div className="widget">
                            ...
                            <p>Delhi Derma Clinic is a modern and responsive Bootstrap HTML template designed for health and medical websites. Ideal for clinics, hospitals, and healthcare professionals seeking a professional online presence with an elegant and user-friendly design.</p>
                        </div>
                        <div className="widget">
                        ...
                        <div className="widget">
                            ...
                            <div className="dz-social-icon style-1">
                                <ul>
                                    ...
                                    <li> <Link href="#" target="_blank"> <i className="fa-brands fa-facebook-f" /> </Link> </li>
                                    <li> <Link href="#" target="_blank"> <i className="fa-brands fa-x-twitter" /> </Link> </li>
                                    <li> <Link href="#" target="_blank"> <i className="fa-brands fa-youtube" /> </Link> </li>
                                </ul>
                            </div>
                        </div>
                    </div>
